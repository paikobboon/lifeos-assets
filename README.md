...
| `mini-v3.png` | The Mini service's avatar (512×512) — the actual Mac mini, on the family navy. Pai's call: the literal object beats a metaphor for a machine-health sender, because you should know which machine is talking without decoding a symbol. Sourced from the Mac mini product icon already present in macOS (`CoreTypes.bundle`). |
| `mini-v2.png` | Superseded. Column base cropped from Theo's illustration — retired in place. |
...
| `mini-v3.png` | `mini-v2.png` (column-base crop) |
